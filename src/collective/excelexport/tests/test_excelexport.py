...
ce sera moi.""",
    ...
    def test_export(self):
        ...
        self.assertEqual(
            sheet2_row1, [u"John Fitzgerald Kennedy", "", "", "", "", "", "", ""]
        )
    ...
    def test_filter_factories(self):
        ...
        class TestContentsDataSource2(FolderContentsDataSource):
            excluded_exportables = ["biography", "birth_date", "amount", "photo"]
    ...
    def test_default_excluded_exportables_record(self):
        ...
        api.portal.set_registry_record(
            name="collective.excelexport.excluded_exportables", value=[u"title"]
        )
    ...
    def test_order_exportables(self):
        class TestContentsDataSource(FolderContentsDataSource):
            exportables_order = ["biography", "birth_date", "amount", "photo"]
